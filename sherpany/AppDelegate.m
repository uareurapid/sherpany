...
//the order of the 2 imports above is important (some restkit bug)
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *storePath = [RKApplicationDataDirectory() stringByAppendingPathComponent:@"Sherpany.sqlite"];
    ...
    //NOTE i could load the users right here, but will do it in the UsersViewController, as is done for the other entities
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.test.sherpany" in the application's documents directory.
...
WE DO NOT NEED THIS DEFAULT STUFF
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"sherpany" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"sherpany.sqlite"];
    NSError *error = nil;
